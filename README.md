...
<h2 id= "acknowledgments" style="text-align: center;margin-top: 0px;">🙏 Acknowledgments</h2>
  ...
  <ul style="text-align: justify;">
    <li><strong>Ms. Fatima Marie P. Agdon, MSCS</strong> – ffor her invaluable guidance, unwavering support, and constant encouragement throughout the course of this project. Her profound expertise, critical insights, and thoughtful direction have played a pivotal role in shaping the development of Agrimart, ensuring its success and the effective execution of this project.
</li>
